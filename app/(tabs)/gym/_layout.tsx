...
const TABS = [
  { title: "routine", icon: "home-outline", iconActive: "person" },
  { title: "plans", icon: "settings-outline", iconActive: "settings" },
  { title: "progress", icon: "settings-outline", iconActive: "settings" },
